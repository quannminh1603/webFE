   ...
   <Loading isLoading={isLoading}>
     <div style={{width: '100%', height: '100vh'}}>
      <div style={{ width: '1270px', margin: '0 auto'}}>
        <h4 style={{textAlign: 'center', fontWeight: 'bold', fontSize: '40px'}}>Chi tiết đơn hàng</h4><br />
        <WrapperHeaderUser>
          <WrapperInfoUser style={{background: '#ccc', padding: '8px'}}>
            <WrapperLabel>Thông tin người nhận</WrapperLabel>
            <WrapperContentInfo>
              <div style={{color: 'blue'}} className='name-info'>{data?.shippingAddress?.fullName}</div>
